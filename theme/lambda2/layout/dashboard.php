...
$category_layout = theme_lambda2_get_setting('category_layout');
if ($category_layout == 2) {$extraclasses[] = 'course-card-min';}
...
echo $OUTPUT->render_from_template('theme_lambda2/dashboard', $templatecontext);